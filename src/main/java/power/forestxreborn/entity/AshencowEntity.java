...
public class AshencowEntity extends PathfinderMob {
	private static final Set<ResourceLocation> SPAWN_BIOMES = Set.of(new ResourceLocation("forest:burned_forest"));

	@SubscribeEvent
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.CREATURE).add(new MobSpawnSettings.SpawnerData(ForestModEntities.ASHENCOW.get(), 20, 4, 4));
	}

	public AshencowEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(ForestModEntities.ASHENCOW.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(ForestModEntities.ASHENCOW.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
