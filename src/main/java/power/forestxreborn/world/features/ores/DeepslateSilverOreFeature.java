...
public class DeepslateSilverOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		PLACED_FEATURE = PlacementUtils.register("forest:deepslate_silver_ore", CONFIGURED_FEATURE, List.of(CountPlacement.of(3),
				InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(1), VerticalAnchor.absolute(32))));
		return FEATURE;
	}
