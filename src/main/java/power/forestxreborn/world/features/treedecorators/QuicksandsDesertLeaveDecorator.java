...
public class QuicksandsDesertLeaveDecorator extends LeaveVineDecorator {
	public static final QuicksandsDesertLeaveDecorator INSTANCE = new QuicksandsDesertLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("quicksands_desert_tree_leave_decorator");
