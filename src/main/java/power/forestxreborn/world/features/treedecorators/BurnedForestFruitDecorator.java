...
public class BurnedForestFruitDecorator extends CocoaDecorator {
	public static final BurnedForestFruitDecorator INSTANCE = new BurnedForestFruitDecorator();
	public static com.mojang.serialization.Codec<BurnedForestFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("burned_forest_tree_fruit_decorator");
