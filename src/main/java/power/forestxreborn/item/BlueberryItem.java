...
import power.forestxreborn.procedures.BlueberryKoghdaNazhataPKMPoBlokuProcedure;
...
public class BlueberryItem extends Item {
	...
	public InteractionResult useOn(UseOnContext context) {
		...
		BlueberryKoghdaNazhataPKMPoBlokuProcedure.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(),
