...
import power.forestxreborn.procedures.RaspberryKoghdaNazhataPKMPoBlokuProcedure;
...
public class RaspberryItem extends Item {
	...
	public InteractionResult useOn(UseOnContext context) {
		...
		RaspberryKoghdaNazhataPKMPoBlokuProcedure.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(),
